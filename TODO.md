...
- [ ] Audio (SFX + music buses, ready for the volume sliders in v0.6.0)
...
## Pre [v0.6.0] Checklist — Run Variety
...
## Pre [v0.7.0] Checklist — Player Power & Maps
...
## Pre [v0.8.0] Checklist — Gear & Progression
*The item layer, plus the meta that hangs off it.*
...
## Pre [v0.9.0] Checklist — Elements & Endgame
*The last big combat system, and the reasons to keep replaying.*
